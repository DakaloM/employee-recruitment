import { UserFragment, UserRole } from '@erecruitment/client';
import {
  DropdownMenuTrigger,
  DropdownMenu,
  Button,
...
import { ChevronDown, HelpCircle, LayoutDashboard, LogIn, LogOut, PowerOff, User, User2Icon } from 'lucide-react';
